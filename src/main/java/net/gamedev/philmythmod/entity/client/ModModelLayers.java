...
public class ModModelLayers {
    public static final ModelLayerLocation BAKUNAWA_LAYER = new ModelLayerLocation(
            new ResourceLocation(PhilippineMythMod.MOD_ID, "bakunawa_layer"), "main");
    public static final ModelLayerLocation ASWANG_LAYER = new ModelLayerLocation(
            new ResourceLocation(PhilippineMythMod.MOD_ID, "aswang_layer"), "main");
    public static final ModelLayerLocation MANANANGGAL_LAYER = new ModelLayerLocation(
            new ResourceLocation(PhilippineMythMod.MOD_ID, "manananggal_layer"), "main");
    public static final ModelLayerLocation KAPRE_LAYER = new ModelLayerLocation(
