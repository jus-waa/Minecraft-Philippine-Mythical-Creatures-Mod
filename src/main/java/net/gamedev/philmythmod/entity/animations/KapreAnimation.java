...
public class KapreAnimation {
	public static final AnimationDefinition idle = AnimationDefinition.Builder.withLength(1.0F).looping()
		...
		.addAnimation("cigarette", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, -1.0F), AnimationChannel.Interpolations.LINEAR)
		))
		.addAnimation("cigarette", new AnimationChannel(AnimationChannel.Targets.SCALE, 
	...
	public static final AnimationDefinition walk = AnimationDefinition.Builder.withLength(2.0F).looping()
		...
		.addAnimation("moss", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
	...
	public static final AnimationDefinition death = AnimationDefinition.Builder.withLength(1.0F).looping()
		...
		.addAnimation("head", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.25F, KeyframeAnimations.posVec(0.0F, -13.19F, 1.86F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.375F, KeyframeAnimations.posVec(0.0F, -47.0F, 3.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.5F, KeyframeAnimations.posVec(0.0F, -63.0F, 3.0F), AnimationChannel.Interpolations.LINEAR)
		))
		.addAnimation("cigarette", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(0.6667F, KeyframeAnimations.degreeVec(110.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
		))
		.addAnimation("cigarette", new AnimationChannel(AnimationChannel.Targets.POSITION, 
