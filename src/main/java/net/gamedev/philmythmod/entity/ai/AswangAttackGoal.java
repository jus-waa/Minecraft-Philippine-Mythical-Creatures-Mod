...
public class AswangAttackGoal extends MeleeAttackGoal {
    private final AswangEntity entity;
    ...
    public AswangAttackGoal(PathfinderMob pMob, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen) {
        super(pMob, pSpeedModifier, pFollowingTargetEvenIfNotSeen);
        entity = ((AswangEntity) pMob);
    }
