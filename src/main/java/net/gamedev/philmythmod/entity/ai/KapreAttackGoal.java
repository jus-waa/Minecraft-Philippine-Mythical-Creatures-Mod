...
public class KapreAttackGoal extends MeleeAttackGoal {
    private final KapreEntity entity;
    ...
    public KapreAttackGoal(PathfinderMob pMob, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen) {
        super(pMob, pSpeedModifier, pFollowingTargetEvenIfNotSeen);
        entity = ((KapreEntity) pMob);
    }
