...
public class MangkukulamAttackGoal extends MeleeAttackGoal {
    private final MangkukulamEntity entity;
    ...
    public MangkukulamAttackGoal(PathfinderMob pMob, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen) {
        super(pMob, pSpeedModifier, pFollowingTargetEvenIfNotSeen);
        entity = ((MangkukulamEntity) pMob);
    }
