...
public class ManananggalAttackGoal extends MeleeAttackGoal {
    private final ManananggalEntity entity;
    ...
    public ManananggalAttackGoal(PathfinderMob pMob, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen) {
        super(pMob, pSpeedModifier, pFollowingTargetEvenIfNotSeen);
        entity = ((ManananggalEntity) pMob);
    }
